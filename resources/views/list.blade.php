        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <ol class='sortable-list user-container'>
                        ...
                        <li data-id="4"><div class="input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-move"></span></span><input type="text" class="form-control" value="Fourth" placeholder="Enter Item Name" /></div><ol></ol></li>
            ...
            <div class="col-md-4">
                <div class="panel panel-default panel-new-template">
                    ...
                    <ol class='sortable-list new-container'>
                        <li data-id="0" id="new-item"><div class="input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-move"></span></span><input type="text" class="form-control" value="New Item" placeholder="Enter Item Name" disabled="disabled" /></div></li>
                        <li data-id="0" id="new-template" style="display: none;"><div class="input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-move"></span></span><input type="text" class="form-control" value="New Item" placeholder="Enter Item Name" disabled="disabled" /></div></li>
                    </ol>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <textarea id="item-log" class="form-control" readonly="readonly">Jimmy said pop!</textarea>
                    </div>
                </div>
            </div>
        </div>
